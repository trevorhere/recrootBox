  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['browserDefault', 'children', 'className', 'labelClassName', 'defaultValue', 'error', 'label', 'multiple', 'placeholder', 'success', 's', 'm', 'l', 'xl', 'type', 'validate', 'onLabel', 'offLabel', 'inline']);
