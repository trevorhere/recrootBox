...
var Autocomplete = function (_Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    value: function renderDropdown(data, minLength, limit) {
      ...
      var matches = this._findRealValue(value);
      ...
      return _react2.default.createElement(
        'ul',
        {
          ...
          ref: function ref(autoCompleteContent) {
            return _this2.autoCompleteContent = autoCompleteContent;
          }
        },
    ...
    value: function _onChange(evt) {
      ...
      this.setState({ value: value, itemSelected: false, activeItem: 0 });
    }
  }, {
    key: '_onKeyDown',
    value: function _onKeyDown(evt) {
      ...
      var matches = this.autoCompleteContent ? this.autoCompleteContent.childNodes : null;
      var matchCount = 0;

      if (this.autoCompleteContent !== null && this.autoCompleteContent !== undefined) {
      ...
      if (evt.keyCode === 13) {
        ...
        var liValue = matches[activeItem].textContent;
        var value = this._findRealValue(liValue);
        this._onAutocomplete(value);
      }
    }
  }, {
    key: '_findRealValue',
    value: function _findRealValue(liValue) {
      var data = this.props.data;

      // go and look to data. if you find a key that have same name with value, return it.

      return Object.keys(data).filter(function (key) {
        var index = key.toUpperCase().indexOf(liValue.toUpperCase());
